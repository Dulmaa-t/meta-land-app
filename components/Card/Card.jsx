...
const Card = () => {
    return (
        <div className="flex flex-row gap-8 my-10">
            <div className="rounded-lg bg-purple p-10 h-[350px]" style={{ willChange: 'transform', transform: 'perspective(1000px)', rotateX: '(0deg)', rotateY: '(0deg)', scale3d: '(1, 1, 1)' }}>
            ...
            <div className="rounded-lg bg-purple p-10 mt-[60px] h-[350px]">
                <Image src={provision} alt="hosting" />
                <h1 className="text-[24px] py-4">Top Resource</h1>
                <p>Oficia dese runt mollit anim id est labo met, consectetur adipis</p>
            </div>
            <div className="rounded-lg bg-purple p-10 h-[350px]">
